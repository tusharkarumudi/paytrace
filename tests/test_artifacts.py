...
HTML = """<html><head>
<meta name="author" content="Hoang Phu Linh">
<img src="//gravatar.com/avatar/205e460b479e2e5b48aec07710c08d50">
<script>gtag('config','G-K7X2M9QP1L'); fbq('init','1234567890123456');</script>
...
async def test_wordpress_users_are_enumerated():
    ...
    from attribution_graph import Identifier
    users = json.dumps([{"name": "Hoang Phu Linh", "slug": "hoanglinh"}])
    ...
    assert any(x.object.value == "wp:hoanglinh" for x in claims
