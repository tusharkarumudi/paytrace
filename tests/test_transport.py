...
Three defects, each a case where a comment described a
...
# ---- budget binds every physical request ---------------------------- #
...
# ---- capture recording is a transport invariant --------------------- #
...
# ---- policy is consulted, not merely constructed -------------------- #
...
# ---- the REAL PolicyEngine against the REAL Fetcher ----------------- #
#
...
# ---- every physical response is captured ---------------------------- #
...
# ---- evidence provenance and credential handling -------------------- #
