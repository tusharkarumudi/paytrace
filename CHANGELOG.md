...
- **Structural SimHash** hashes the HTML tag sequence with text stripped. Exact
  ...
  portfolio page. Measured on instavisor.net: text distance 22, structural
...
operator name. An audit showed five identifier kinds emitted and never accepted
...
The investigation stopped where it should start. An audit found `PERSON_NAME`
...
### Fixed (1.6.0) — transport defects found by external audit
