...
def _run(args: argparse.Namespace) -> int:
    ...
    ua = (f"paytrace/2.0.0 (case {scope.case_ref}; "
...
def _portfolio(args: argparse.Namespace) -> int:
    ...
    fetcher = Fetcher(
        user_agent="paytrace/2.0.0 (+https://github.com/tusharkarumudi/paytrace)",
...
def _keyaccounts(a: argparse.Namespace) -> int:
    ...
    fetcher = Fetcher(user_agent="paytrace/2.0.0 (+keyaccounts)", max_requests=8)
